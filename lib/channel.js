 ...
 */
function create(step1, ep1, step2, ep2) {
	...
	if (ep1.canPull /*&& ep2.canPush*/ ) {
		// TODO
		let generatorObject;

		imp1 = function (aGeneratorFunction) {
			//console.log(`imp1 ${this} ${aGeneratorFunction}`);
		...
		imp2 = function (aGeneratorObject) {
			//console.log(`imp2 ${aGeneratorObject}`);
			return function* () {
