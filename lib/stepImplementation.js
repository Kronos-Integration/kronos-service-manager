...
fs.readdirSync(path.join(__dirname, stepsSubdir)).forEach(function (filename) {
...
/* TODO Hallo Markus, sollten wir hier nicht lieber eine function bauen die Steps aus einem verzecinis lesen
 und registrieren kann? Dann könnte die generell verwendet werden.

function registerStepsFromDir(dir, cb) {
