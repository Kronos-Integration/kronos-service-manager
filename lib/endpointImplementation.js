...
const defaultEndpoint = {
  toString() {
    ...
    /**
     * @return true when endpoint can be active, false otherwise
     */
    get canBeActive() {
      return this.direction.match(/active/) ? true : false;
    },

    /**
     * @return true when endpoint can be passive, false otherwise
     */
    get canBePassive() {
      return this.direction.match(/passive/) ? true : false;
    },
    ...
    get initialize() {
      return function (manager, aGeneratorFunction) {
        /*
                if(this.canBePassive && !aGeneratorFunction) {
                  console.log(`${this}: generator missing`);
                }

                console.log(`active: ${this.canBeActive} passive: ${this.canBePassive} generator: ${aGeneratorFunction ? true : false}`);
        */
