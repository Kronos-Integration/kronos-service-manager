  ...
  toString() {
    ...
    get initialize() {
      return function (aGeneratorFunction) {
        ...
        const generatorFunction = this.implementation(aGeneratorFunction);

        if (!generatorFunction) return undefined;

        const generatorObject = generatorFunction();

        //console.log(`initialize ${this.name} -> ${generatorObject}`);

        /*
                if (this.isOut && aGeneratorFunction && generatorObject) {
