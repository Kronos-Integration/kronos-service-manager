...
const defaultEndpoint = {
  toString() {
     ...
     */
    get isIn() {
      return this.direction.match(/in/);
    },
     ...
     */
    get isOut() {
      return this.direction.match(/out/);
    },
     ...
     */
    get canPull() {
      return this.direction.match(/pull/);
    },
     ...
     */
    get canPush() {
      return this.direction.match(/push/);
    },
    ...
    get initialize() {
      return function (generator) {
        const generatorFunction = this.implementation.apply(this, generator);
