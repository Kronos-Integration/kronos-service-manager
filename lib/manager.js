...
mix(service.Service).with(events.EventEmitter)
*/

class ServiceManager extends serviceServiceProviderMixin(service.Service) {
  ...
  constructor(config) {
    ...
    rgm.defineRegistrarProperties(this, 'Interceptor', 'interceptors');
