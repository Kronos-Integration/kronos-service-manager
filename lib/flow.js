    ...
    initialize(manager, parentStep) {
      for (let sid in this.steps) {
        ...
        try {
          ...
          // TODO
          console.log(`error: ${e} ${step.meta.name}`);
...
exports.create = function (manager, flowDefinitions, progressReporter) {
  ...
  // LINK: Ich würde den ProgressReporter hier rausnehmen.Der muss immer übergeben werden
  // normal wird diese funktion sowieso nur vom manager aufgerufen
  // if (!pr) {
